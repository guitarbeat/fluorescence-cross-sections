"""
    ...
    Classes/Functions:
        ...
        - update_floating_element_theme() (line 112)
        ...
        - TissuePlotConfig (line 254):
            ...
            - get_photon_trace(wavelengths: list, normalized_fraction: list) -> dict (line 300)
            - get_absorption_trace(wavelengths: list, absorption: list, is_above_threshold: bool) -> dict (line 310)
