"""
    ...
    Classes/Functions:
        - FPbaseAPI (line 29):
            - _create_session() -> requests.Session (line 44)
            - _make_request(endpoint: str, params: Dict[str, Any], timeout: int = 10) -> requests.Response (line 69)
            - _validate_params(params: Dict[str, Any]) -> Dict[str, Any] (line 97)
            - get_search_url(params: Dict[str, Any]) -> str (line 122)
            - search_proteins(params: Dict[str, Any], timeout: int = 10) -> List[ProteinData] (line 128)
            - to_dataframe(proteins: List[ProteinData]) -> pd.DataFrame (line 176)
