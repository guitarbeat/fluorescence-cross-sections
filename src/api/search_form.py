"""
    ...
    Classes/Functions:
        - download_results(df: pd.DataFrame) -> None (line 18)
        - search_proteins(query: str, filters: Dict[str, Any], client: FPbaseAPI) -> Dict[str, Any] (line 30)
        - render_search_panel(key_prefix: str = '') -> None (line 94)
