"""
    ...
    Classes/Functions:
        - FluorophoreManager (line 26):
            - get_column_config() -> Dict[str, Any] (line 42)
            - save_data(df: pd.DataFrame) -> None (line 77)
            - render_editor() -> None (line 100)
            - _handle_import() -> None (line 144)
        - render_fluorophore_manager() (line 179)
